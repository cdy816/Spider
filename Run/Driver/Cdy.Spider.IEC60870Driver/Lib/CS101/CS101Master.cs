...
namespace lib60870.CS101
{
    public class CS101Master : Master, IPrimaryLinkLayerCallbacks
    {
        ...
        ///// <param name="llParams"></param>
        ///// <param name="alParams"></param>
        //public CS101Master(ICommChannel2 comm ,LinkLayerMode mode, LinkLayerParameters llParams = null, ApplicationLayerParameters alParams = null)
        //{
        //    if (llParams == null)
        ...
        //    this.transceiver = new SerialTransceiverFT12(comm,linkLayerParameters, DebugLog);
        ...
        /// 
        /// </summary>
        /// <param name="serialStream"></param>
        /// <param name="mode"></param>
        /// <param name="llParams"></param>
        /// <param name="alParams"></param>
        public CS101Master(ICommChannel2 serialStream, LinkLayerMode mode, LinkLayerParameters llParams = null, ApplicationLayerParameters alParams = null)
        {
            if (llParams == null)
                this.linkLayerParameters = new LinkLayerParameters();
            else
