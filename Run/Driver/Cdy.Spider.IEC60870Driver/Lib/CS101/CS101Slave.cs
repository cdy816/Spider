...
namespace lib60870
{
    namespace CS101
    {
        ...
        public class CS101Slave : Slave, ISecondaryApplicationLayer, IMasterConnection
        {
            ...
            //public CS101Slave(LinkLayerParameters parameters = null)
            //{
            //    //this.port = port;
            ...
            //    transceiver = new SerialTransceiverFT12(linkLayerParameters, DebugLog);
            ...
            /// <param name="parameters">link layer parameters</param>
            public CS101Slave(ICommChannel2 serialStream, LinkLayerParameters parameters = null)
            {
                linkLayerParameters = parameters;
