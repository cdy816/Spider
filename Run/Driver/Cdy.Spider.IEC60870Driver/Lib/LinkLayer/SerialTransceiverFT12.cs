...
namespace lib60870.linklayer
{
    ...
    internal class SerialTransceiverFT12
    {
        ...
        private ICommChannel2 serialStream = null;
        ...
        //public SerialTransceiverFT12(LinkLayerParameters linkLayerParameters, Action<string> debugLog)
        //{
        //    //this.port = port;
        ...
        public SerialTransceiverFT12(ICommChannel2 serialStream, LinkLayerParameters linkLayerParameters, Action<string> debugLog)
        {
            //this.port = null;
        ...
        public void SendMessage(byte[] msg, int msgSize)
        {
            ...
            try
            {
                ...
                serialStream.Send(msg, 0, msgSize);
                serialStream.Flush();
            }
