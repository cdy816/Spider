...
{
    public class OmronFinsUDPProxy : NetworkDeviceProxyBase
    {
        ...
        public OmronFinsUDPProxy(DriverRunnerBase driver) : base(driver)
        {
            this.WordLength = 1;
        ...
        {
            return OmronFinsNetHelper.UdpResponseValidAnalysis(response,out string erro);
        }
