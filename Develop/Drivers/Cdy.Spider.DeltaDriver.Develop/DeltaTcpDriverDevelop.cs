...
namespace Cdy.Spider.DeltaDriver.Develop
{
    ...
    /// 
    /// </summary>
    public class DeltaTcpDriverDevelop : DriverDevelop
    {
        ...
        /// 
        /// </summary>
        public override string Desc => Res.Get("DeltaTcpDesc");
        ...
        {
            return new DeltaTcpDriverDevelop() { Data = new DeltaDriverData() };
        }
