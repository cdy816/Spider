...
namespace Cdy.Spider.InovanceDriver.Develop
{
    ...
    /// 
    /// </summary>
    public class InovanceSerialDriverDevelop : DriverDevelop
    {
        ...
        /// 
        /// </summary>
        public override string Desc => Res.Get("InovanceSerialDesc");
        ...
        {
            return new InovanceSerialDriverDevelop() { Data = new InovanceDriverData() };
        }
