...
namespace Cdy.Spider.InovanceDriver.Develop
{
    ...
    /// 
    /// </summary>
    public class InovanceSerialDriverDevelopViewModel : ViewModelBase
    {
        ...
        /// 
        /// </summary>
        public InovanceDriverData Model { get; set; }
        ...
        public int InovanceSeries
        {
            ...
            set
            {
                ...
                {
                    Model.Serise = (Spider.InovanceDriver.InovanceSeries)  value;
