...
{
    public class MQTTServerChannelDevelop : ChannelDevelopBase
    {
        ...
        {
            return new MQTTServerChannelConfigViewModel() { Model = mData };
        }
        ...
        {
            return new MQTTServerChannelDevelop() { Data = CreatNewData() };
        }
