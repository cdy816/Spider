...
namespace Cdy.Spider.OpcDriver.Develop
{
    ...
    /// 
    /// </summary>
    public class OpcDriverDevelop : DriverDevelop
    {
        ...
        /// 
        /// </summary>
        public override DriverData Data { get => mData; set => mData = value as OpcDriverData; }
        ...
        {
            return new OpcDriverDevelopViewModel() { Model = mData };
        }
        ...
        {
            return new OpcDriverDevelop() { mData = new OpcDriverData() };
        }
        ...
        {
            return new OpcDriverConfigModel();
        }
