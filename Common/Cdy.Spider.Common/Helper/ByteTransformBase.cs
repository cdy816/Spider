...
namespace Cdy.Spider.Common
{
    ...
    public class ByteTransformBase : IByteTransform
    {
        ...
        public bool[] TransBool( byte[] buffer, int index, int length )
        {
            ...
            return DataExtend.ByteToBoolArray( tmp, length * 8 );
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<short>(this.TransInt16(buffer, index, row * col), row, col);
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<ushort>(this.TransUInt16(buffer, index, row * col), row, col);
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<int>(this.TransInt32(buffer, index, row * col), row, col);
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<uint>(this.TransUInt32(buffer, index, row * col), row, col);
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<long>(this.TransInt64(buffer, index, row * col), row, col);
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<ulong>(this.TransUInt64(buffer, index, row * col), row, col);
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<float>(this.TransSingle(buffer, index, row * col), row, col);
        }
        ...
        {
            return DataExtend.CreateTwoArrayFromOneArray<double>(this.TransDouble(buffer, index, row * col), row, col);
        }
        ...
        public virtual byte[] TransByte( bool[] values )
        {
            ...
            return DataExtend.BoolArrayToByte( values );
        }
        ...
        public virtual byte[] TransByte(string value, int length, Encoding encoding)
        {
            ...
            else
            {
                ...
                result = (this.IsStringReverseByteWord ? DataExtend.ArrayExpandToLength<byte>(DataExtend.BytesReverseByWord(bytes), length) : DataExtend.ArrayExpandToLength<byte>(bytes, length));
            }
            return result;
        }
        #endregion
